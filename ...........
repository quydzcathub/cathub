...
local Window = Fluent:CreateWindow({
    Title = "Hiru Hub",
    SubTitle = "Version Beta 5⁵ | By Nguyen Vu Duy",
    TabWidth = 160,
...
local Tabs = {
    home = Window:AddTab({ Title = "Tab Profile", Icon = "activity" }),
    Main = Window:AddTab({ Title = "Tab Main Farm", Icon = "home" }),
    Sea = Window:AddTab({ Title = "Tab Sea Even", Icon = "align-vertical-distribute-center" }),
...
local listfastattack = {'0.01','0.05','0.015','0.001','0.1','0.005','0','0.02'}
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {
        ...
        Description = "",
        Default = false })
    loadstring(game:HttpGet("https://raw.githubusercontent.com/NGUYENVUDUY1/Lub/main/file.txt"))()
...
local ToggleSafeM = Tabs.Main:AddToggle("ToggleSafeM", {Title = "Anti Flag", Description = "", Default = true })
...
spawn(function()
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto Farm Elite Hunter",Description = "", Default = false })
