...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì Akiki Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "Akiki Hub", HidePremium = false, IntroText = "NightHub Library", SaveConfig = true, ConfigFolder = "Akiki Hub"})
...
OrionLib:MakeNotification({
	Name = "Akiki Hub",
	Content = "Akiki Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
